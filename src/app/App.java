...
import static app.options.Option.option_btns;

public class App {
    private final String version = "1.1.1";
    private final JFrame frame = new JFrame("zFile");
    ...
    public static void init() {
        try {
            InputStream regularStream = App.class.getResourceAsStream("/fonts/Poppins-Regular.ttf");
            Font poppinsRegular = Font.createFont(Font.TRUETYPE_FONT, regularStream).deriveFont(14f);

            InputStream mediumStream = App.class.getResourceAsStream("/fonts/Poppins-Medium.ttf");
        ...
        try {
            IntelliJTheme.setup(
                    App.class.getResourceAsStream("/themes/zFile.theme.json")
            );
    ...
    public static void show_disclaimer() {
    ...
    public App() {
        ...
        // title of the app
        JLabel title = new JLabel("zFile v." + version);
